...
namespace baryonyx
{
    ...
    public:
        ...
        constexpr explicit bitboard(const u64 bb): m_data(bb) {}
        ...
        {
            return static_cast<bool>(bitboard.m_data & 1ULL << static_cast<u8>(sq));
        }

        static constexpr void set_bit(bitboard& bitboard, const square sq)
        {
            bitboard.m_data |= 1ULL << static_cast<u8>(sq);
        }
